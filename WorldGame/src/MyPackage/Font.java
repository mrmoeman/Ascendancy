...
class MyFont {
	 ...
	 static int texture;
	    ...
	    public static NumberFormat numberFormat = NumberFormat.getInstance();
	     ...
	     public static void Print(String msg, Float X, Float Y) {                                      // Custom GL "Print" Routine
	    	 
	    	 GL11.glLoadIdentity();                                              // Reset The Current Modelview Matrix
	          // Position The Text On The Screen
	          GL11.glTranslatef(X, Y, -3.0f);      
	     ...
	     public static void Print(String msg, Float X, Float Y, Float Z) {                                      // Custom GL "Print" Routine
